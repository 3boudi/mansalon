/* ==========================================================================
   L'Atelier Homme - Interactivity & Visual Effects Script
   ========================================================================== */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.addEventListener('scroll', () => {
        // Sticky Header Elevation (using new L'Atelier Homme colors)
        if (window.scrollY > 50) {
            header.style.backgroundColor = 'rgba(244, 246, 244, 0.95)';
            header.style.boxShadow = '0 4px 20px rgba(18, 21, 19, 0.03)';
        } else {
            header.style.backgroundColor = 'rgba(244, 246, 244, 0.9)';
